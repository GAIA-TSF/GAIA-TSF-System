...
The **Data Processing sub-system** serves as the central refinement engine
of the architecture, responsible for transforming raw inputs into
standardized, analysis-ready information products. It encompasses
...
Infrastructure (SDI) and downstream Machine Learning (MAP) sub-systems.
