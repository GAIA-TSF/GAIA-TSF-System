...
while ROOT_DIR != "/":
    if (
        os.path.exists(os.path.join(ROOT_DIR, "plugins")) and
        os.path.exists(os.path.join(ROOT_DIR, "core")) and
        os.path.exists(os.path.join(ROOT_DIR, "pipelines"))
    ):
        break
...
def main():
    ...
    # 3. Register plugins
    import plugins  # triggers plugin registration via __init__.py
