...
```
python3 prototype/dag/debug_run.py --config config.yaml --pipeline slope 
```
...
```
python3 -m pytest prototype/dag/tests/test_amd_pipeline.py 

python3 -m pytest prototype/dag/tests/test_slope_pipeline.py  
